...
export const hero = {
  ...
  subheadline:
    'Precisa de ajuda com um site no Lovable, um app no Cursor ou um fluxo que trava no meio do caminho? Sou desenvolvedor há mais de 13 anos — com passagem por Mercado Livre, Mercado Bitcoin, Grupo Boticário e BNY Mellon — e hoje também atendo pessoas e negócios da Grande Florianópolis, como consultor especialista em IA e automação.',
